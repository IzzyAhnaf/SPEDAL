const DeletebukuModal = ({ isOpen, onClose, onDelete, bookName }) => {
    if (!isOpen) return null;
    return (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
            <div className="bg-white rounded-xl p-6 w-11/12 sm:w-96 shadow-lg">
                <h2 className="text-xl font-bold mb-4 text-center">Hapus Buku</h2>
                <p className="mb-6 text-center">
                    Yakin ingin menghapus <span className="font-semibold">{bookName}</span>?
                </p>
...
export default DeletebukuModal